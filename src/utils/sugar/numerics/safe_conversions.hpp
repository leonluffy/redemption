...
REDEMPTION_CXX14_CONSTEXPR Dst checked_cast(Src value);


// analogous to static_cast<> for integral types,
// except that use std::clamp if the conversion is overflow or underflow.
template <class Dst, class Src>
REDEMPTION_CXX14_CONSTEXPR Dst saturated_cast(Src value);
...
struct checked_int
{
    ...
    template<class U>
    REDEMPTION_CXX14_CONSTEXPR checked_int(U i) noexcept
    : i(checked_cast<T>(i))
    {}
...
struct saturated_int
{
    ...
    template<class U>
    REDEMPTION_CXX14_CONSTEXPR saturated_int(U i) noexcept
...
namespace detail
{
    ...
    template <class Dst, class Src>
    REDEMPTION_CXX14_CONSTEXPR Dst checked_cast(type_<Dst>, Src value)
    {
    #ifndef NDEBUG
    ...
    template <class Dst, class Src>
    REDEMPTION_CXX14_CONSTEXPR Dst saturated_cast(type_<Dst>, Src value)
    {
