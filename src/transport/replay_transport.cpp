...
, data_out_pos(0)
{
    LOG(LOG_INFO, "ReplayTransport::ReplayTransport()");
...
{
    LOG(LOG_INFO, "ReplayTransport::enable_client_tls");
...
{
    LOG(LOG_INFO, "ReplayTransport::do_partial_read(%zu)", len);
    this->read_timer();
...
{
    LOG(LOG_INFO, "ReplayTransport::do_atomic_read(%zu)", len);
    this->read_timer();
...
{
    LOG(LOG_INFO, "ReplayTransport::do_send(%zu)", len);
